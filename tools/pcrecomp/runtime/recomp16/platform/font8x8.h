/*
 * font8x8.h - Embedded 8x8 bitmap font (IBM CP437)
 *
 * Standard IBM PC/VGA 8x8 character set for text mode rendering.
 * Each character is 8 bytes (8 rows of 8 pixels, MSB = leftmost pixel).
 *
 * Part of the Civ Recomp project (sp00nznet/civ)
 */

#ifndef CIV_FONT8X8_H
#define CIV_FONT8X8_H

#include <stdint.h>

/* 256 characters, 8 bytes each (8x8 bitmap, 1 bit per pixel) */
static const uint8_t font8x8_cp437[256][8] = {
    ...
    /* 0x06 ♠   */ {0x10,0x38,0x7C,0xFE,0xFE,0x10,0x38,0x00},
    ...
    /* 0x79 'y' */ {0x00,0x00,0xC6,0xC6,0xCE,0x7E,0x06,0xFC},
    ...
    /* 0x80-0xFF: box drawing, accented chars, etc. - simplified */
    /* For characters 0x80-0xFF, use a simple filled/empty block pattern */
    {0x3C,0x42,0x99,0xA1,0xA1,0x99,0x42,0x3C}, /* 0x80 */
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, /* 0x81 */
    {0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x30}, /* 0x82 */
    ...
    {0x18,0x00,0x18,0x18,0x3C,0x3C,0x18,0x00}, /* 0xA1 */
    ...
    {0x55,0xAA,0x55,0xAA,0x55,0xAA,0x55,0xAA}, /* 0xB0 light shade */
    {0x55,0xFF,0xAA,0xFF,0x55,0xFF,0xAA,0xFF}, /* 0xB1 med shade */
    {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}, /* 0xB2 dark shade */
    ...
    {0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00,0x00}, /* 0xDD ▌ - simplified */
    {0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00,0x00}, /* 0xDE ▐ - simplified */
    {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}, /* 0xDF ▀ */
    /* 0xE0-0xEF: Greek/math symbols (simplified as blanks) */
    ...
    {0x00,0x00,0x00,0x7E,0x00,0x7E,0x00,0x00}, /* 0xF1 ± */
    ...
    {0x00,0x18,0x18,0x00,0x00,0x00,0x00,0x00}, /* 0xFA · */
...
/* CGA/EGA/VGA text mode attribute color table (16 colors) */
